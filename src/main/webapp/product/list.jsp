...
<li><a href="Search?category=A2">B2</a></li>
</ul>
<h3>키워드 검색</h3>
<div>
...
<!-- core 태그 if : test 에 조건식 사용합니다. empty는 문자열 메소드 중에 null과 빈 문자열 체크 -->
...
<!-- items 의 $ { } 기호는 list 애트리뷰트값(request.getAttribute 실행) 가져옵니다.
dto 변수는 list 에서 하나씩 가져온 요소를 저장. -->
<tr>
<td>${status.count}</td> <!-- status 변수는 forEach 실행정보 저장 -->
<td>${dto.pcode}</td>
<td>${dto.category}</td>
<td>${dto.pname}</td>
<!-- <td>{dto.price}</td> -->
